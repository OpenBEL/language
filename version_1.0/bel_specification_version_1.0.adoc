= BEL 1.0 Specification [DEPRECATED]
...
This is the home of the BEL Language Documentation v1.0.

_Please cite the BEL v1.0 language documentation as "BEL v1.0 Language Documentation, https://github.com/OpenBEL/language ", along with the date accessed._

[WARNING]
====
*OpenBEL is not supported!*

The https://bel.bio[BEL.bio] project is supported and is also hosting an up to date BEL Language website at https://language.bel.bio[BEL Language].

BEL is now >= 2.1 and the 2.0.0+ versions are documented at the BEL.bio Language website.

This OpenBEL BEL Language document is the only specification of BEL 1.0 version as the BEL.bio Language website starts at 2.0.0
====
...
All SET values should be quoted.
